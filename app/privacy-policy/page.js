      ...
      <div className="flex min-h-screen flex-col items-center pl-8 pr-8 pb-10 pt-10 leading-relaxed justify-center">
        <div className="max-w-4xl">
          ...
          <ul className="list-disc pl-8">
            ...
            <li>
              <p>
                ...
                to the Company as the legal entity that collects Consumers&apos;
                personal information and determines the purposes and means of
                the processing of Consumers&apos; personal information, or on
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to chan4est.
              </p>
              <br />
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to chan4est, accessible from{" "}
                <Link
                  className="underline hover:text-accent"
                  href="https://chan4est.com/"
          ...
          <p>
            ...
            and legal guardians to monitor their children&apos;s Internet usage
          ...
          <ul className="list-disc pl-8">
            ...
            <li>
              ...
              (and direct our Service Providers to correct) Your personal
            ...
            <li>
              <p>
                ...
                right to request the deletion of Your Personal Data under
                certain circumstances, subject to certain exceptions. Once We
                receive and confirm Your request, We will delete (and direct Our
            ...
            <li>
              <p>
                ...
                have the right not to be discriminated against for exercising
          ...
          <ul className="list-disc pl-8">
            <li>
              ...
              <a
                className="underline hover:text-accent"
                href="mailto:chan4est@gmail.com"
              >
                chan4est@gmail.com
              </a>
            </li>
